...
DEFAULT_RESOURCES = ['public.mars-0.8.3.zip', 'public.pyodps-0.11.0.zip', 'public.pyarrow.zip']
...
class MarsCupidClient(object):
    ...
    def submit(self, image=None, supervisor_num=1, supervisor_cpu=4, supervisor_mem=16 * 1024 ** 3,
               ...
               with_notebook=False, notebook_cpu=1, notebook_mem=2 * 1024 ** 3,
               with_graphscope=False, coordinator_cpu=1,
        ...
        try:
            ...
            if self._kube_instance is None:
                ...
                cluster_args = dict(
                    image=image, supervisor_num=supervisor_num, supervisor_cpu=supervisor_cpu,
                    ...
                    worker_disk_size=worker_disk_size, with_notebook=with_notebook, notebook_cpu=notebook_cpu,
    ...
    def count_workers(self):
        resp = self._req_session.get(self._endpoint + '/api/cluster/nodes?role=1', timeout=1)
            ...
            with warnings.catch_warnings():
                ...
                try:
                    if self._endpoint is None:
                        ...
                        self._req_session.post(self._endpoint.rstrip('/') + '/api/pyodps_logger', data=dict(
